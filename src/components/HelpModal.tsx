    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          ...
          <li><b>Koń 2</b> i <b>Smok 2</b> to te same wierzchowce w wersji z gotowych modeli (Poly Pizza, autor Quaternius, licencja CC0) z animacją szkieletową: koń idzie stępem, galopuje i skacze, smok macha skrzydłami w zawisie i w szybkim locie. Sterowanie jest takie samo jak u proceduralnych odpowiedników.</li>
          <li><b>Koń</b> rusza od razu: <kbd>W</kbd> to stęp, <kbd>Shift</kbd> galop, <kbd>S</kbd> cofanie, <kbd>A</kbd>/<kbd>D</kbd> skręt — także w miejscu. <kbd>Spacja</kbd> (przycisk <b>Skok</b>) to sus w górę. Koń trzyma się gruntu: wjeżdża na wzgórza i schodzi w doliny wokół planszy.</li>
          ...
          <li>Na telefonie joystick steruje przechyłem i nosem (na koniu jazdą i skrętem), a przyciski <b>Gaz +</b> i <b>Gaz −</b> po prawej zmieniają obroty (na smoku <b>W górę</b> i <b>W dół</b>); koń ma zamiast nich przycisk <b>Skok</b>, a smok i czerw obok nich przycisk <b>Ogień</b> albo <b>Wyskok</b>.</li>
        </ul>
