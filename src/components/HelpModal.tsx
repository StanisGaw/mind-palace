    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          ...
          <li><b>Skok ze spadochronem</b>: w powietrzu <kbd>F</kbd> (na padzie <kbd>▢</kbd>, na telefonie przycisk wysiadki) wyrzuca Cię z kokpitu. Spadasz swobodnie, aż <kbd>Spacja</kbd> (<kbd>✕</kbd>, przycisk <b>Spadochron</b>) otworzy czaszę; poniżej 20 m nad ziemią otwiera się sama. Na czaszy sterujesz jak w spacerze (<kbd>WASD</kbd>, gałka), a spojrzenie wyznacza kierunek. Skoczyć można tylko nad planszą i przynajmniej 5 m nad ziemią. Samolot leci dalej sam: krąży nad planszą, szybuje w dół i zostaje tam, gdzie się zatrzyma.</li>
          <li>Na <b>padzie</b>: <kbd>R2</kbd> dodaje gazu, <kbd>L2</kbd> ujmuje (spusty są analogowe, więc obroty zmieniają się płynnie — im mocniej wciśniesz, tym szybciej), lewa gałka to ster wysokości i przechył, <kbd>L1</kbd>/<kbd>R1</kbd> to ster kierunku, prawa gałka rozgląda po kokpicie, a <kbd>▢</kbd> wysadza po wylądowaniu. Krzyżak w górę i w dół nadal zmienia gaz skokowo, co dziesiątą część.</li>
        ...
        <ul>
          ...
          <li><b>Jakość obrazu</b> (na dole tego samego panelu) dobiera się sama do sprzętu: na telefonie i tablecie średnia, na komputerze wysoka. Możesz ją narzucić ręcznie — niska wyłącza cienie i rysuje w rozdzielczości ekranu. Niezależnie od wyboru, gdy obraz zaczyna się ciąć, rozdzielczość obniża się sama i wraca, kiedy jest lżej.</li>
        </ul>
