    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          ...
          <li>Na telefonie joystick steruje przechyłem i nosem (na koniu jazdą i skrętem), a przyciski <b>Gaz +</b> i <b>Gaz −</b> po prawej zmieniają obroty; koń ma zamiast nich przycisk <b>Skok</b>, a smok i czerw obok gazu przycisk <b>Ogień</b> albo <b>Wyskok</b>.</li>
        </ul>
