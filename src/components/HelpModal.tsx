    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          ...
          <li>Na telefonie: joystick po lewej, <b>przeciąganie po dowolnym miejscu sceny</b> rozgląda (także kilkoma palcami naraz — przełożenie kciuka w połowie obrotu nic nie przerywa), przycisk <b>Skok</b> po prawej na dole, dotknięcie obiektu — wybór. W edytorze pasek stawiania ma „Obróć”, „Wiele” i „Anuluj”, a w rzucie z góry palec przesuwa planszę. Obróć telefon poziomo: belki znikają, menu i panele są pod ikonami przy lewej krawędzi.</li>
        </ul>
        <h3>Pojazdy i wierzchowce</h3>
        <ul>
          <li>W bibliotece, w kategorii <b>Pojazdy</b>, są <b>Samolot</b>, <b>Taksówka latająca</b>, <b>Smok wierzchowy</b>, <b>Koń</b>, <b>Czerw pustynny</b> i <b>Czerw kielichowy</b>. W widoku z oczu podejdź do siodła albo kabiny i naciśnij <kbd>F</kbd> (albo kliknij podpowiedź) — siadasz i ruszasz. Myszą rozglądasz się z siodła, także na boki i za siebie. Żeby <b>zsiąść</b>, zatrzymaj się na planszy i naciśnij <kbd>F</kbd>: wierzchowiec zostaje tam, gdzie go zostawisz, a Ty stajesz obok, twarzą do niego.</li>
          ...
          <li><b>Smok wierzchowy</b> lata jak śmigłowiec: <kbd>Shift</kbd> unosi, <kbd>Ctrl</kbd> opuszcza, a puszczone — smok zawisa w miejscu, machając skrzydłami. <kbd>W</kbd>/<kbd>S</kbd> to lot do przodu i do tyłu, <kbd>A</kbd>/<kbd>D</kbd> skręt w locie, <kbd>Q</kbd>/<kbd>E</kbd> obrót w miejscu. <kbd>Spacja</kbd> albo kliknięcie (na padzie <kbd>△</kbd>, na telefonie przycisk <b>Ogień</b>) każe mu zionąć ogniem.</li>
          <li><b>Taksówka latająca</b> lata tak samo jak smok (<kbd>Shift</kbd> unosi, <kbd>Ctrl</kbd> opuszcza, puszczone — zawisa), tylko nie zieje ogniem. Siedzisz w przeszklonej kabinie, więc rozglądasz się przez szyby.</li>
          <li><b>Koń</b> (model z Poly Pizza, autor Quaternius, licencja CC0, z animacją stępu, galopu i skoku) rusza od razu: <kbd>W</kbd> to stęp, <kbd>Shift</kbd> galop, <kbd>S</kbd> cofanie, <kbd>A</kbd>/<kbd>D</kbd> skręt — także w miejscu. <kbd>Spacja</kbd> (przycisk <b>Skok</b>) to sus w górę. Koń trzyma się gruntu: wjeżdża na wzgórza i schodzi w doliny wokół planszy.</li>
          ...
          <li><b>Czerw kielichowy</b> jeździ tak samo, ale jest cięższy: wolniej się rozpędza i skręca, za to wyskakuje wyżej. Paszczę tworzą cztery mięsiste płaty, które rozchylają się w wyskoku jak kielich — w środku widać zęby. To najbardziej szczegółowy model w bibliotece, więc lepiej postawić jednego niż dziesięciu.</li>
          <li><b>Przeszkody</b>: wierzchowce i maszyny zatrzymują się na budynkach, murach i pniach drzew (samolot i smok w powietrzu tracą pęd, więc uważaj na wieże), a nad dachem przelatuje się swobodnie. Zwierzęta omijają obrysy budynków, a gdy się o nie otrą, zawracają.</li>
          <li>Gdy wierzchowiec albo maszyna <b>otrze się o budynek</b>, nie staje w miejscu: układa się wzdłuż ściany i sunie dalej. Im ostrzejszy kąt, tym mniej traci prędkości — muśnięcie elewacji przy locie ulicą kosztuje niemal nic, wejście prosto w mur wyhamowuje mocno, ale lot trwa i można z niego wyjść. Gaz zostaje taki, jaki był.</li>
          ...
          <li>Na <b>padzie</b>: <kbd>R2</kbd> dodaje gazu, <kbd>L2</kbd> ujmuje (na smoku unoszą i opuszczają; spusty są analogowe, więc obroty zmieniają się płynnie — im mocniej wciśniesz, tym szybciej), lewa gałka to ster wysokości i przechył (na koniu jazda i skręt), <kbd>L1</kbd>/<kbd>R1</kbd> to ster kierunku, prawa gałka rozgląda, <kbd>✕</kbd> skacze na koniu i czerwiu, <kbd>△</kbd> to ogień smoka, a <kbd>▢</kbd> zsiada po zatrzymaniu. Krzyżak w górę i w dół nadal zmienia gaz skokowo, co dziesiątą część.</li>
          <li>Na telefonie joystick steruje przechyłem i nosem (na koniu jazdą i skrętem), a przyciski <b>Gaz +</b> i <b>Gaz −</b> po prawej zmieniają obroty (na smoku <b>W górę</b> i <b>W dół</b>); koń ma zamiast nich przyciski <b>Skok</b> i <b>Galop</b> (galop trzyma się do ponownego dotknięcia), a smok i czerw obok nich przycisk <b>Ogień</b> albo <b>Wyskok</b>.</li>
        </ul>
        ...
        <ul>
          ...
          <li><b>Wioska w dolinie</b> jest zaznaczona domyślnie: gotowa osada na planszy 80 × 80 m — brama, droga przez rynek ze studnią prosto do dworu, aleja cyprysów, biblioteka, wieża widokowa, kapliczka, trzy chaty, staw z altaną, sad, obozowisko przy lesie, a dookoła las, wzgórza, wodospad i góry. Przy południowej krawędzi jest <b>pas startowy</b> z samolotem, a obok czekają smok wierzchowy i koń. Do wszystkich budynków da się wejść — wystarczy dopisywać wspomnienia. <b>Neonowe miasto</b> to nocna metropolia w deszczu na tej samej planszy: asfaltowe ulice w siatce, plac z fontanną, wieżowce i megawieżowce ze świecącymi oknami, neony, ekrany reklamowe, latarnie uliczne, bloki z wnętrzami (centrala korporacji, serwerownia, archiwum danych, nocny bar, bloki mieszkalne), lądowisko z latającymi taksówkami, a poza planszą panorama wieżowców. <b>Pusta plansza</b> to sama łąka 40 × 40 m.</li>
