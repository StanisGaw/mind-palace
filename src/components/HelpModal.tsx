    ...
    <div className="modal-bg" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul>
          ...
          <li><b>Czerw kielichowy</b> jeździ tak samo, ale jest cięższy: wolniej skręca, za to wyskakuje wyżej. Zamiast szczęk z zębami ma cztery płaty, które rozchylają się w wyskoku jak kielich.</li>
