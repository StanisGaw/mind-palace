...
export const CATALOG: CatalogItem[] = [
  ...
  { id: 'duneworm', name: 'Czerw kielichowy', category: 'vehicle', emoji: '🐛', description: 'Czerw z paszczą rozchylającą się jak kielich. Dosiądź głowy i płyń po planszy, wyskakując z piasku.', footprint: 4.5, maxScale: 3, collider: 'trimesh', emitter: 'sand', outdoorOnly: true },
  // Rośliny
