...
export const CATALOG: CatalogItem[] = [
  // Budynki
  { id: 'palace', name: 'Pałac', category: 'building', emoji: '🏛️', description: 'Kopuła i kolumnada — miejsce na najważniejsze idee.', footprint: 4.4 },
  { id: 'library', name: 'Biblioteka', category: 'building', emoji: '📚', description: 'Budynek z portykiem, dobry na wiedzę i fakty.', footprint: 4.0 },
  ...
  { id: 'duneworm', name: 'Czerw kielichowy', category: 'vehicle', emoji: '🐛', description: 'Czerw o mięsistej skórze z porami, z paszczą rozchylającą się jak kielich i zębami w gardzieli. Najbardziej szczegółowy model w bibliotece — jeden na scenę.', footprint: 5, maxScale: 3, collider: 'box', emitter: 'sand', outdoorOnly: true },
  // Rośliny
  ...
  { id: 'vase', name: 'Wazon z kwiatami', category: 'furniture', emoji: '💐', description: 'Pięć kwiatów na stole albo komodzie.', footprint: 0.2, collider: 'none' },
  { id: 'curtains', name: 'Zasłony', category: 'furniture', emoji: '🎭', description: 'Bordowe draperie z karniszem.', footprint: 0.6, collider: 'none' },
